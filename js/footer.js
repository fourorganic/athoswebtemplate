...
(function () {
  ...
  var home = isIndex ? '#top' : (isProductPage ? '../index.html#top' : 'index.html#top');
  var contacto = isIndex ? '#cta-final' : (isProductPage ? '../index.html#cta-final' : 'index.html#cta-final');
  ...
  var html = ''
    ...
    + '<div class="row gy-4">'
    + '<div class="col-lg-4">'
    + '<a class="navbar-brand fw-bold d-inline-block mb-3" href="' + home + '">Fourmidable</a>'
    ...
    + '<ul class="list-unstyled footer-links">'
    + '<li><a href="' + prod + 'acido-hipocloroso.html">Bruma Facial HOCl</a></li>'
    + '<li><a href="' + prod + 'extracto-curcuma.html">Extracto de Cúrcuma</a></li>'
    + '<li><a href="' + prod + 'protector-solar-tonka.html">Protector Solar de Tonka</a></li>'
    + '</ul>'
    + '</div>'
    + '<div class="col-lg-3">'
    ...
    + '<li><i class="bi bi-envelope me-2"></i><a href="mailto:hola@fourmidable.co">hola@fourmidable.co</a></li>'
